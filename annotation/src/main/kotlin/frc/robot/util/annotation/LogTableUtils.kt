...
object LogTableUtils {
    ...
    fun <T : StructSerializable> LogTable.kGet(key: String, defaultValue: T) =
        this.getFromWPISerializable(key, defaultValue)
    ...
    fun <T, MessageType : ProtoMessage<*>> LogTable.kPut(key: String, proto: Protobuf<T, MessageType>, value: T) =
        put(key, proto, value)
    ...
    fun <T> LogTable.kGet(key: String, struct: Struct<T>, defaultValue: Array<T>): Array<T> =
        get(key, struct, *defaultValue)

    fun <T, MessageType : ProtoMessage<*>> LogTable.kGet(
        key: String,
        proto: Protobuf<T, MessageType>,
        defaultValue: T,
    ): T = get(key, proto, defaultValue)
