...
interface FieldLayout {
    ...
    companion object {
        ...
        fun getTag(side: ReefLocation): Int {
            when (side) {
                is CoralPlacement -> return when (side) {
                ...
                is UnifiedReefLocation -> {
                    return when (side) {
                        UnifiedReefLocation.A, UnifiedReefLocation.B, UnifiedReefLocation.AB -> getFieldLayout().REEF_AB
                        UnifiedReefLocation.C, UnifiedReefLocation.D, UnifiedReefLocation.CD -> getFieldLayout().REEF_CD
                        UnifiedReefLocation.E, UnifiedReefLocation.F, UnifiedReefLocation.EF -> getFieldLayout().REEF_EF
                        UnifiedReefLocation.G, UnifiedReefLocation.H, UnifiedReefLocation.GH -> getFieldLayout().REEF_GH
                        UnifiedReefLocation.I, UnifiedReefLocation.J, UnifiedReefLocation.IJ -> getFieldLayout().REEF_IJ
                        UnifiedReefLocation.K, UnifiedReefLocation.L, UnifiedReefLocation.KL -> getFieldLayout().REEF_KL
                        UnifiedReefLocation.NONE -> throw IllegalArgumentException("Cannot get non-existent tag for ReefLocation.NONE")
                    }
                }
