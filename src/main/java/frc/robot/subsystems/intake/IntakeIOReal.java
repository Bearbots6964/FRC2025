...
public class IntakeIOReal implements IntakeIO {
    ...
    public IntakeIOReal(SparkBaseConfig flywheelConfig, SparkBaseConfig axisConfig) {
        ...
        intakeFlywheelMotor =
            new SparkMax(
                    Constants.IntakeConstants.getIntakeFlywheelMotorID(), SparkLowLevel.MotorType.kBrushless
            );
        ...
        intakeAxisConfig
            ...
            .openLoopRampRate(5)
            .disableFollowerMode();
        intakeAxisConfig.absoluteEncoder
    ...
    public void updateInputs(IntakeIOInputs inputs) {
        inputs.intakeFlywheelVoltage = intakeFlywheelMotor.getAppliedOutput() * intakeFlywheelMotor.getBusVoltage();
