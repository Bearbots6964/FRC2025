...
public class ArmIOTalonFX implements ArmIO {
    ...
    public ArmIOTalonFX(SparkBaseConfig armConfiguration) {
        ...
        armMotor = new SparkMax(Constants.ArmConstants.getArmAxisMotorID(),
        ...
        armConfiguration.smartCurrentLimit(20)
            .idleMode(IdleMode.kBrake).softLimit.forwardSoftLimitEnabled(true)
            .forwardSoftLimit(180.0).reverseSoftLimitEnabled(true).reverseSoftLimit(0.0);
        armConfiguration.openLoopRampRate(5).disableFollowerMode();
        armConfiguration.closedLoop.p(0.015).i(0).d(0).maxOutput(0.25).minOutput(-0.25)
        ...
        tryUntilOk(armMotor, 5, () -> armMotor.configure(armConfiguration,
