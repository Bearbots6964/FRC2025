...
public abstract class ModuleIOTalonFX implements ModuleIO {
    ...
    protected ModuleIOTalonFX(
        ...
        driveTalon = new TalonFX(constants.DriveMotorId, TunerConstants.getDrivetrainConstants().CANBusName);
        turnTalon = new TalonFX(constants.SteerMotorId, TunerConstants.getDrivetrainConstants().CANBusName);
        cancoder = new CANcoder(constants.EncoderId, TunerConstants.getDrivetrainConstants().CANBusName);
        ...
        if (Constants.getCurrentMode() == Constants.Mode.SIM) {
