...
public class ElevatorIOTalonFX implements ElevatorIO {
  ...
  protected final MotionMagicTorqueCurrentFOC motionMagicPositionRequest= new MotionMagicTorqueCurrentFOC(0.0);
  protected final MotionMagicVelocityTorqueCurrentFOC motionMagicVelocityRequest = new MotionMagicVelocityTorqueCurrentFOC(0.0);
  ...
  protected ElevatorIOTalonFX(TalonFXConfiguration leftConfig, TalonFXConfiguration rightConfig) {
  ...
  public void updateInputs(ElevatorIOInputs inputs) {
    var leftStatus = BaseStatusSignal.refreshAll(leftMotorPosition, leftMotorVelocity, leftMotorVoltage, leftMotorTemperature, leftMotorCurrent);
    var rightStatus = BaseStatusSignal.refreshAll(rightMotorPosition, rightMotorVelocity, rightMotorVoltage, rightMotorTemperature, rightMotorCurrent);
